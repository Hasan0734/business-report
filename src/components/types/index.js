    ...
    >
      <div className="container px-4">
        <div className="text-white text-center">
          <h2 className="font-bold capitalize text-2xl lg:text-4xl mb-4 font-amiko">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 mt-20 gap-y-10 lg:gap-y-0 lg:gap-x-4">
          <ul className="text-white flex flex-col gap-y-3">
            {lists1 &&
              lists1.map((list, i) => (
                <li
                  className="flex items-center gap-x-3 font-amiko font-semibold"
                  key={i}
                >
          ...
          <ul className="text-white flex flex-col gap-y-3">
            {lists2 &&
              lists2.map((list, i) => (
                <li
                  className="flex items-center font-amiko gap-x-3 font-semibold"
                  key={i}
                >
                  <span className="w-6 h-6 rounded-full border flex items-center justify-center">
                    <TiTick />
